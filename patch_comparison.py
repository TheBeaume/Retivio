...
content = r'''export default function ComparisonSection() {
...
Path("src/components/landing/ComparisonSection.jsx").write_text(content)

landing = Path("src/pages/LandingPage.jsx")
text = landing.read_text()

if 'import ComparisonSection from "../components/landing/ComparisonSection";' not in text:
    text = text.replace(
...
print("Comparison section added successfully.")
