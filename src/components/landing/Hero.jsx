...
export default function Hero() {
  return (
    <section className="bg-gradient-to-br from-purple-900 via-purple-700 to-purple-600 text-white">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4">
              ...
              <button className="border border-white px-8 py-4 rounded-xl hover:bg-white hover:text-purple-700 transition">
                🔑 Login
              </button>
