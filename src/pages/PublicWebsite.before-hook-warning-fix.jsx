...
function PublicWebsite() {
  ...
  const media = project?.website_media || {};
  const siteSettings = media.siteSettings || {};
  const blogSettings = media.blogSettings || {};
  const blogPosts = Array.isArray(media.blogPosts)
    ? media.blogPosts
    : [];
  const legalContent = media.legalContent || {};
    ...
    <div className="min-h-screen bg-white text-slate-950">
      <header className="border-b border-slate-100 bg-white">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-5">
          <a href={base} className="text-xl font-extrabold">
      ...
      <section
        className="px-5 py-24 text-center text-white sm:py-32"
